...
public final class Constants implements CommonConstants {
    ...
    // order line types
    public static final Integer ORDER_LINE_TYPE_ITEM = Integer.valueOf(1);
    public static final Integer ORDER_LINE_TYPE_TAX = Integer.valueOf(2);
    public static final Integer ORDER_LINE_TYPE_PENALTY = Integer.valueOf(3);
    
    // order periods. This are those NOT related with any single entity
    public static final Integer ORDER_PERIOD_ONCE = Integer.valueOf(1);
    
    // period unit types
    public static final Integer PERIOD_UNIT_MONTH = Integer.valueOf(1);
    public static final Integer PERIOD_UNIT_WEEK = Integer.valueOf(2);
    public static final Integer PERIOD_UNIT_DAY = Integer.valueOf(3);
    public static final Integer PERIOD_UNIT_YEAR= Integer.valueOf(4);
    
    // order billing types
    public static final Integer ORDER_BILLING_PRE_PAID = Integer.valueOf(1);
    public static final Integer ORDER_BILLING_POST_PAID = Integer.valueOf(2);
    
    // pluggable tasks categories
    public static final Integer PLUGGABLE_TASK_PROCESSING_ORDERS = Integer.valueOf(1);
    public static final Integer PLUGGABLE_TASK_ORDER_FILTER = Integer.valueOf(2);
    public static final Integer PLUGGABLE_TASK_INVOICE_FILTER = Integer.valueOf(3);
    public static final Integer PLUGGABLE_TASK_INVOICE_COMPOSITION = Integer.valueOf(4);
    public static final Integer PLUGGABLE_TASK_ORDER_PERIODS = Integer.valueOf(5);
    public static final Integer PLUGGABLE_TASK_PAYMENT = Integer.valueOf(6);
    public static final Integer PLUGGABLE_TASK_NOTIFICATION = Integer.valueOf(7);
    public static final Integer PLUGGABLE_TASK_PAYMENT_INFO = Integer.valueOf(8);
    public static final Integer PLUGGABLE_TASK_PENALTY = Integer.valueOf(9);
    public static final Integer PLUGGABLE_TASK_PROCESSOR_ALARM = Integer.valueOf(10);
    public static final Integer PLUGGABLE_TASK_SUBSCRIPTION_STATUS = Integer.valueOf(11);
    public static final Integer PLUGGABLE_TASK_ASYNC_PAYMENT_PARAMS = Integer.valueOf(12);
    public static final Integer PLUGGABLE_TASK_ITEM_MANAGER = Integer.valueOf(13);
    public static final Integer PLUGGABLE_TASK_ITEM_PRICING = Integer.valueOf(14);
    ...
    public static final Integer PLUGGABLE_TASK_INTERNAL_EVENT = Integer.valueOf(17);
    public static final Integer PLUGGABLE_TASK_EXTERNAL_PROVISIONING = Integer.valueOf(18);
    public static final Integer PLUGGABLE_TASK_VALIDATE_PURCHASE = Integer.valueOf(19);
    public static final Integer PLUGGABLE_TASK_BILL_PROCESS_FILTER = Integer.valueOf(20);
    public static final Integer PLUGGABLE_TASK_MEDIATION_ERROR_HANDLER = Integer.valueOf(21);
    public static final Integer PLUGGABLE_TASK_SCHEDULED = Integer.valueOf(22);
    public static final Integer PLUGGABLE_TASK_RULES_GENERATOR = Integer.valueOf(23);
    public static final Integer PLUGGABLE_TASK_AGEING = Integer.valueOf(24);
    
    // pluggable task types (belongs to a category)
    public static final Integer PLUGGABLE_TASK_T_PAPER_INVOICE = Integer.valueOf(12);
    
    // invoice line types
    public static final Integer INVOICE_LINE_TYPE_ITEM_RECURRING = Integer.valueOf(1);
    public static final Integer INVOICE_LINE_TYPE_TAX = Integer.valueOf(2);
    public static final Integer INVOICE_LINE_TYPE_DUE_INVOICE = Integer.valueOf(3);
    public static final Integer INVOICE_LINE_TYPE_PENALTY = Integer.valueOf(4);
    public static final Integer INVOICE_LINE_TYPE_SUB_ACCOUNT = Integer.valueOf(5);
    public static final Integer INVOICE_LINE_TYPE_ITEM_ONETIME = Integer.valueOf(6);

    // permission types - this should be moved to PermissionConstant.java
    public static final Integer PERMISSION_TYPE_MENU= Integer.valueOf(1);
    
    // languages - when the project is a big company, we can do this right ! :p
    public static final Integer LANGUAGE_ENGLISH_ID = Integer.valueOf(1);
    public static final String LANGUAGE_ENGLISH_STR = "English";
    public static final Integer LANGUAGE_SPANISH_ID = Integer.valueOf(2);
    public static final String LANGUAGE_SPANISH_STR = "Spanish";    

    public static final Integer ORDER_PROCESS_ORIGIN_PROCESS = Integer.valueOf(1);
    public static final Integer ORDER_PROCESS_ORIGIN_MANUAL = Integer.valueOf(2);

    //Notification Preference Types
    public static final Integer PREFERENCE_TYPE_SELF_DELIVER_PAPER_INVOICES = Integer.valueOf(13);
    public static final Integer PREFERENCE_TYPE_INCLUDE_CUSTOMER_NOTES = Integer.valueOf(14);
    public static final Integer PREFERENCE_TYPE_DAY_BEFORE_ORDER_NOTIF_EXP = Integer.valueOf(15);
    public static final Integer PREFERENCE_TYPE_DAY_BEFORE_ORDER_NOTIF_EXP2 = Integer.valueOf(16);
    public static final Integer PREFERENCE_TYPE_DAY_BEFORE_ORDER_NOTIF_EXP3 = Integer.valueOf(17);
    public static final Integer PREFERENCE_TYPE_USE_INVOICE_REMINDERS = Integer.valueOf(21);
    public static final Integer PREFERENCE_TYPE_NO_OF_DAYS_INVOICE_GEN_1_REMINDER = Integer.valueOf(22);
    public static final Integer PREFERENCE_TYPE_NO_OF_DAYS_NEXT_REMINDER = Integer.valueOf(23);
    ...
    // contact type
    public static final Integer ENTITY_CONTACT_TYPE = Integer.valueOf(1);

    //Jbilling Table Ids
    public static final Integer ENTITY_TABLE_ID = Integer.valueOf(5);
}
