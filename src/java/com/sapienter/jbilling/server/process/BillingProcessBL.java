...
public class BillingProcessBL extends ResultList
            ...
            try {
                ...
                if (isProcessable) {
                    ...
                    if (holder == null) {
                        ...
                        holder.setIsReview(isReview ? Integer.valueOf(1) : Integer.valueOf(0));
            ...
            try {
                ...
                if (isProcessable) {
                    ...
                    if (thisInvoice == null) {
                        ...
                        thisInvoice.setIsReview(isReview ? Integer.valueOf(1) : Integer.valueOf(0));
    ...
    private InvoiceDTO generateDBInvoice(Integer userId,
        ...
        newInvoice.setInProcessPayment(Integer.valueOf(1));
    ...
    public BillingProcessDTOEx getDtoEx(Integer language) {
        ...
        grandTotal.setInvoicesGenerated(Integer.valueOf(totalInvoices));

        retValue.setRetries(Integer.valueOf(runsCounter));
        retValue.setRuns(runs);
        retValue.setGrandTotal(grandTotal);
        retValue.setBillingDateEnd(getEndOfProcessPeriod(billingProcess));
        retValue.setOrdersProcessed(Integer.valueOf(billingProcess.getOrderProcesses().size()));
    ...
    public Integer[] getToRetry(Integer entityId)
        ...
        while (cachedResults.next()) {
            list.add(Integer.valueOf(cachedResults.getInt(1)));
        }
    ...
    public void purgeReview(Integer entityId, boolean isReview) {
        ...
        if (configBL.getEntity().getGenerateReport().intValue() == 1 &&
                !Integer.valueOf(configBL.getEntity().getReviewStatus()).equals(
