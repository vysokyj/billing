 ...
 * 
 */
public class SimpleProvisioningCommandsRulesTask extends PluggableTask implements IInternalEventsTask {
    private static final Logger LOG = Logger.getLogger(SimpleProvisioningCommandsRulesTask.class);
