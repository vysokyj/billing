...
public final class UserDTOEx extends UserDTO {
    ...
    public static final Integer STATUS_ACTIVE = Integer.valueOf(1); // this HAS to be the very first status
    public static final Integer STATUS_SUSPENDED = Integer.valueOf(5); 
    public static final Integer STATUS_DELETED = Integer.valueOf(8); // this HAS to be the last status
    
    // subscriber status in synch with db table subscriber_status
    public static final Integer SUBSCRIBER_ACTIVE = Integer.valueOf(1); 
    public static final Integer SUBSCRIBER_PENDING_UNSUBSCRIPTION = Integer.valueOf(2);
    public static final Integer SUBSCRIBER_UNSUBSCRIBED = Integer.valueOf(3);
    public static final Integer SUBSCRIBER_PENDING_EXPIRATION= Integer.valueOf(4);
    public static final Integer SUBSCRIBER_EXPIRED = Integer.valueOf(5);
    public static final Integer SUBSCRIBER_NONSUBSCRIBED = Integer.valueOf(6);
    public static final Integer SUBSCRIBER_DISCONTINUED = Integer.valueOf(7);
