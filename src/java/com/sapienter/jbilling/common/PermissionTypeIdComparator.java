...
public class PermissionTypeIdComparator implements Comparator<PermissionDTO> {
    ...
    public int compare(PermissionDTO perA, PermissionDTO perB) {
        ...
        aTypeId = (perA.getPermissionType() == null) ? Integer.valueOf(-1) :
                perA.getPermissionType().getId(); 
        bTypeId = (perB.getPermissionType() == null) ? Integer.valueOf(-1) :
                perB.getPermissionType().getId();
        aFId = (perA.getForeignId() == null) ? Integer.valueOf(-1) :
                perA.getForeignId(); 
        bFId = (perB.getForeignId() == null) ? Integer.valueOf(-1) :
                perB.getForeignId(); 
