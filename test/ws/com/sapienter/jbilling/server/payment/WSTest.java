...
public class WSTest extends TestCase {
    ...
    public void testApplyGet() {
        try {
            ...
            payment.setUserId(Integer.valueOf(2));
            ...
            Integer ret = api.applyPayment(payment, Integer.valueOf(35));
            ...
            assertEquals("payment not related to invoice", retPayment.getInvoiceIds()[0], Integer.valueOf(35));
            ...
            assertEquals("New invoice not paid", retInvoice.getToProcess(), Integer.valueOf(0));
            ...
            retPayment = api.getLatestPayment(Integer.valueOf(2));
            assertNotNull("didn't get payment ", retPayment);
            ...
            try {
                ...
                retPayment = api.getLatestPayment(Integer.valueOf(13));
            ...
            Integer retPayments[] = api.getLastPayments(Integer.valueOf(2), Integer.valueOf(2));
            ...
            try {
                ...
                retPayments = api.getLastPayments(Integer.valueOf(13),
                	Integer.valueOf(2));
                fail("User 13 belongs to entity 301");
            } catch (Exception e) {
            }
    ...
    public void testBlacklistFilters() {
        try {
            ...
            for(int i = 0; i < 6; i++, userId++) {
                ...
                order.setPeriod(2);
                order.setCurrencyId(Integer.valueOf(1));
    ...
    public void testProcessPayment(){
        try {
            JbillingAPI api = JbillingAPIFactory.getAPI();
            final Integer USER_ID = Integer.valueOf(1071);
