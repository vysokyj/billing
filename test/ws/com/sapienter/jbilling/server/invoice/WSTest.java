...
public class WSTest extends TestCase {
    ...
    public void testGet() {
        try {
            ...
            assertEquals("invoice id", retInvoice.getId(), Integer.valueOf(15));
            ...
            assertNotNull("invoice not returned", retInvoice);
            assertEquals("invoice's user id", retInvoice.getUserId(), Integer.valueOf(2));
            System.out.println("Got = " + retInvoice);
            ...
            assertEquals("invoice's user id", Integer.valueOf(2), retInvoice.getUserId());
    ...
    public void testDelete() {
        try {
            JbillingAPI api = JbillingAPIFactory.getAPI();
            Integer invoiceId = Integer.valueOf(1);
            ...
            try {
                api.deleteInvoice(Integer.valueOf(75));
