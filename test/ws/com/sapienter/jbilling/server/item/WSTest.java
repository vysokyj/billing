...
public class WSTest  extends TestCase {
    ...
    public void testPricingRules() {
    	...
    	try {
    		...
    		ItemDTOEx it = api.getItem(Integer.valueOf(1), Integer.valueOf(2), new PricingField[] { pf });
        	...
        	try {
        		...
        		it = api.getItem(Integer.valueOf(4), Integer.valueOf(2), new PricingField[] { pf });
        	} catch (Exception e) {
        		passed = true;
        	}
    ...
    private OrderWS prepareOrder() {
        ...
        newOrder.setUserId(Integer.valueOf(2)); 
        newOrder.setBillingTypeId(Constants.ORDER_BILLING_PRE_PAID);
        newOrder.setPeriod(Integer.valueOf(1)); // once
    ...
    public void testGetAllItems() {
        try {
            ...
            assertEquals("ID", Integer.valueOf(1), items[0].getId());
            assertEquals("Number", "DP-1", items[0].getNumber());
            assertEquals("Type 1", Integer.valueOf(1), items[0].getTypes()[0]);
            ...
            assertEquals("ID", Integer.valueOf(2), items[1].getId());
            assertEquals("Number", "DP-2", items[1].getNumber());
            assertEquals("Type 1", Integer.valueOf(1), items[1].getTypes()[0]);
            ...
            assertEquals("ID", Integer.valueOf(3), items[2].getId());
            assertEquals("Number", "DP-3", items[2].getNumber());
            assertEquals("Type 1", Integer.valueOf(1), items[2].getTypes()[0]);
            ...
            assertEquals("ID", Integer.valueOf(14), items[3].getId());
            assertEquals("Number", "J-01", items[3].getNumber());
            assertEquals("Type 12", Integer.valueOf(12), items[3].getTypes()[0]);

            assertEquals("Description", "Cancel fee", items[4].getDescription());
            assertEquals("Price", new BigDecimal("5"), items[4].getPriceAsDecimal());
            assertEquals("ID", Integer.valueOf(24), items[4].getId());
            assertEquals("Number", "F-1", items[4].getNumber());
            assertEquals("Type 22", Integer.valueOf(22), items[4].getTypes()[0]);
            ...
            assertEquals("Type 1", Integer.valueOf(1), items[lastItem].getTypes()[0]);
    ...
    public void testUpdateItem() {
    	...
    	try {
	    	...
	    	ItemDTOEx item = api.getItem(Integer.valueOf(1), Integer.valueOf(2), new PricingField[] {} );
	    	...
	    	ItemDTOEx itemChanged = api.getItem(Integer.valueOf(1), Integer.valueOf(2), new PricingField[] {} );
    ...
    public void testCurrencyConvert() {
    	try {
            ...
            ItemDTOEx item = api.getItem(Integer.valueOf(240), Integer.valueOf(2), new PricingField[] {} );
