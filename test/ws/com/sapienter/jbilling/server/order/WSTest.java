...
public class WSTest  extends TestCase {
    ...
    public void testCreateUpdateDelete() throws Exception {
        ...
        */
        ...
        newOrder.setCurrencyId(Integer.valueOf(1));
        ...
        line.setItemId(Integer.valueOf(1));
        lines[0] = line;
        ...
        line.setTypeId(Constants.ORDER_LINE_TYPE_ITEM);
        line.setQuantity(Integer.valueOf(1));
        line.setItemId(Integer.valueOf(2));
        ...
        line.setTypeId(Constants.ORDER_LINE_TYPE_ITEM);
        line.setQuantity(Integer.valueOf(1));
        line.setItemId(Integer.valueOf(3));
        line.setUseItem(Boolean.TRUE);
        lines[2] = line;
        ...
        */
        ...
        try {
            api.getOrder(Integer.valueOf(5));
        ...
        */
        ...
        try {
            ...
            api.getOrderLine(Integer.valueOf(6));
        ...
        for (i = 0; i < retOrder.getOrderLines().length; i++) {
            ...
            if (retOrderLine.getItemId().equals(Integer.valueOf(14))) {
                assertEquals("created line item id", retOrderLine.getItemId(), Integer.valueOf(14));
        ...
        */
        ...
        retOrderLine.setQuantity(Integer.valueOf(99));
        ...
        retOrderLine.setQuantity(Integer.valueOf(0));
        api.updateOrderLine(retOrderLine);
        ...
        */
        ...
        retOrder.getOrderLines()[1].setQuantity(Integer.valueOf(2));
        retOrder.getOrderLines()[1].setUseItem(false);
        retOrder.setStatusId(Integer.valueOf(2));
        ...
        try {
            ...
            retOrder.setId(Integer.valueOf(5));
            api.updateOrder(retOrder);
            fail("Order 5 belongs to entity 2");
        } catch (Exception e) {
        }
        ...
        assertEquals("Status id", Integer.valueOf(2), retOrder.getStatusId());
        ...
        */
        ...
        OrderWS lastOrder = api.getLatestOrder(Integer.valueOf(2));
        ...
        try {
            retOrder = api.getLatestOrder(Integer.valueOf(13));
        ...
        */
        ...
        Integer[] list = api.getLastOrders(Integer.valueOf(2), Integer.valueOf(5));
        ...
        retOrder = api.getOrder(Integer.valueOf(list[0]));
        ...
        */
        ...
        try {
            api.deleteOrder(Integer.valueOf(5));
            fail("Order 5 belongs to entity 2");
        } catch (Exception e) {
        }
        ...
        */
        ...
        try {
            api.getOrderByPeriod(Integer.valueOf(13), Integer.valueOf(1));
            fail("User 13 belongs to entity 2");
        } catch (Exception e) {
        }
        ...
        Integer orders[] = api.getOrderByPeriod(Integer.valueOf(2), Integer.valueOf(1));
        ...
        */
        ...
        pause(2000); // pause while provisioning status is being updated
        System.out.println("Getting latest");
        retOrder = api.getLatestOrder(Integer.valueOf(2));
    ...
    public void testUpdateLines() throws Exception {
        ...
        Integer orderId = Integer.valueOf(15);
        ...
        line.setTypeId(Constants.ORDER_LINE_TYPE_ITEM);
        line.setQuantity(Integer.valueOf(1));
        line.setItemId(Integer.valueOf(14));
        line.setUseItem(Boolean.TRUE);
    ...
    public void testRefundAndCancelFee() throws Exception {
        ...
        line = new OrderLineWS();
        line.setTypeId(Constants.ORDER_LINE_TYPE_ITEM);
        line.setQuantity(Integer.valueOf(5));
        line.setItemId(Integer.valueOf(1));
        line.setUseItem(Boolean.TRUE);
        lines[0] = line;
        ...
        Integer[] list = api.getLastOrders(Integer.valueOf(USER_ID), Integer.valueOf(3));
        assertNotNull("Missing list", list);
        ...
        assertEquals("Item Id", Integer.valueOf(3), orderLine.getItemId());
        ...
        assertEquals("No. of order lines", 1, order.getOrderLines().length);
        orderLine = order.getOrderLines()[0];
        assertEquals("Item Id", Integer.valueOf(24), orderLine.getItemId());
        ...
        assertEquals("No. of order lines", 1, order.getOrderLines().length);
        orderLine = order.getOrderLines()[0];
        assertEquals("Item Id", Integer.valueOf(1), orderLine.getItemId());
        assertEquals("Quantity", new BigDecimal("-2.00"), orderLine.getQuantityAsDecimal());
        ...
        list = api.getLastOrders(Integer.valueOf(USER_ID), Integer.valueOf(3));
        assertNotNull("Missing list", list);
        ...
        // remove invoices
        list = api.getLastInvoices(Integer.valueOf(USER_ID), Integer.valueOf(2));
        api.deleteInvoice(list[0]);
        api.deleteInvoice(list[1]);
        // remove orders
        list = api.getLastOrders(Integer.valueOf(USER_ID), Integer.valueOf(7));
    ...
    public void testInternalEventsRulesTask() throws Exception {
        ...
        assertEquals("Item id 1 was removed", Integer.valueOf(2), orderLines[0].getItemId());
        ...
        assertEquals("Item id 1 was removed", Integer.valueOf(2), invoiceLines[0].getItemId());
    ...
    public void testCurrentOrder() throws Exception {
        ...
        newLine.setItemId(Integer.valueOf(1));
        newLine.setQuantity(new BigDecimal("22.00"));
        newLine.setUseItem(Boolean.TRUE); // use the price and description from the item
