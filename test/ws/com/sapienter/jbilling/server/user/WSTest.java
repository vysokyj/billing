...
public class WSTest extends TestCase {
    ...
    public void testGetUser() {
        try {
            ...
            UserWS ret = api.getUserWS(Integer.valueOf(2));
            assertEquals(2, ret.getUserId());
            try {
                System.out.println("Getting invalid user 13");
                ret = api.getUserWS(Integer.valueOf(13));
...
*/
    ...
    public void testCreateUpdateDeleteUser() {
        try {
            ...
            assertEquals("New invoice paid", retInvoice.getToProcess(), Integer.valueOf(0));
            ...
            */
            ...
            try {
                ...
                api.getUserWS(Integer.valueOf(13));
                fail("Shouldn't be able to access user 13");
            } catch (Exception e) {
            }
            ...
            users = api.getUsersNotInStatus(Integer.valueOf(1));
    ...
    public void testLanguageId() {
        try {
            ...
            newUser.setLanguageId(Integer.valueOf(2)); // French
    ...
    */
    ...
    public void testRulesValidatePurchaseTask() {
        try {
            ...
            newLine.setItemId(Integer.valueOf(3));
            newLine.setQuantity(new BigDecimal("10.0"));
            // take the price and description from the item
            newLine.setUseItem(Boolean.TRUE);
    ...
    public void testAutoRecharge() throws Exception {
        ...
        order.setBillingTypeId(Constants.ORDER_BILLING_PRE_PAID);
        order.setPeriod(Integer.valueOf(1));
