...
public class BillingProcessTest extends TestCase {
    ...
    public void testEndOfMonthCorrection() throws Exception {
        ...
        config.setRetries(Integer.valueOf(1));
        config.setDaysForRetry(Integer.valueOf(5));
        config.setGenerateReport(Integer.valueOf(1));
        config.setAutoPayment(Integer.valueOf(1));
        config.setAutoPaymentApplication(Integer.valueOf(1));
        config.setDfFm(Integer.valueOf(0));
        ...
        config.setMaximumPeriods(Integer.valueOf(10));
        config.setOnlyRecurring(Integer.valueOf(1));
        config.setPeriodUnitId(Constants.PERIOD_UNIT_MONTH);
        config.setPeriodValue(Integer.valueOf(1));
...
//                     invoice.getBalanceAsDecimal());
    ...
    public void testRetry() throws Exception {
        ...
        config.setRetries(Integer.valueOf(1));
        config.setDaysForRetry(Integer.valueOf(5));
        config.setGenerateReport(Integer.valueOf(0));
        config.setAutoPayment(Integer.valueOf(1));
        config.setAutoPaymentApplication(Integer.valueOf(1));
        config.setDfFm(Integer.valueOf(0));
        config.setDueDateUnitId(Constants.PERIOD_UNIT_MONTH);
    ...
    public void testReview() throws Exception {
        ...
        // set the configuration to something we are sure about
        BillingProcessConfigurationWS config = api.getBillingProcessConfiguration();
        config.setDaysForReport(Integer.valueOf(5));
        config.setGenerateReport(Integer.valueOf(1));
...
//                               .floatValue() < 1);
            ...
            InvoiceWS invoice = api.getInvoiceWS(invoiceIds[0]);
            assertEquals("Invoice is paid", Integer.valueOf(0), invoice.getToProcess());
        } catch (Exception e) {
            e.printStackTrace();
            fail("Exception:" + e);
        }
