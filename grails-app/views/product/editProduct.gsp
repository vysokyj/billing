                ...
                <div class="form-columns">
                    <div class="column">
                        ...
                        <g:applyLayout name="form/input">
                            ...
                            <g:textField class="field" name="product.percentageAsDecimal" value="${product?.percentage?.isNumber() ? formatNumber(number: product?.percentage, maxFractionDigits: '4') : product?.percentage}" size="6"/>
                        </g:applyLayout>
